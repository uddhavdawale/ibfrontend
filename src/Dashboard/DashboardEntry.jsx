...
const navigate = useNavigate();
  ...
  // Interactive Inventory Data (Real-time updates)
  ...
  // ADD THIS NEW EFFECT - Auto close dropdown
  useEffect(() => {
  ...
  <div className="user-profile">
    ...
    {showProfileMenu && (
      <div className="profile-dropdown">
        ...
        <button 
            className="menu-item"   onClick={() => { setShowProfileMenu(false); navigate('/Profile');  // Navigate to profile page
            }}
          >
            <span>👤</span> Profile
          </button>
